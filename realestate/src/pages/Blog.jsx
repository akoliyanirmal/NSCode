...
const Blogs = () => {
  return (
    <>
      <section id="Blog" className="popular-properties py-[80px] pt-40">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            <div className="col-span-1 lg:col-span-8">
              ...
              <blockquote className="italic text-secondary leading-relaxed mb-4">
              ...
              <div className="mt-10">
                <h2 className="font-lora text-primary text-2xl capitalize font-medium">
                ...
                <ul className="mt-8 space-y-6">
                  <li className="flex flex-col sm:flex-row items-start">
                    <img
                      src="	https://htmldemo.net/bery/bery/assets/images/commentor/01.png"
                      className="mr-4 w-20 h-20 rounded-full"
                      alt="Commentor"
                    />
                    <div className="flex-1">
                      <h4 className="ext-primary text-lg font-medium mb-2">
                        Stela Flemming,
                  ...
                  <li className="flex flex-col sm:flex-row items-start">
                    <img
                      src="https://htmldemo.net/bery/bery/assets/images/commentor/02.png"
                      className="mr-4 w-20 h-20 rounded-full"
                      alt="Commentor"
                    />
                    <div className="flex-1">
                  ...
                  <li className="flex flex-col sm:flex-row items-start">
                    <img
                      src="	https://htmldemo.net/bery/bery/assets/images/commentor/03.png"
                      className="mr-4 w-20 h-20 rounded-full"
                      alt="Commentor"
                    />
                    <div className="flex-1">
                ...
                <h2 className="font-lora text-primary text-2xl capitalize mt-10 font-medium">
                  Leave a Message.
                </h2>
                ...
                >
                  <input
                    ...
                    className="col-span-1 w-full  hover:border-[#FD6400] border border-primary border-opacity-60 rounded-md p-2"
                  />
                  ...
                  <textarea
                    placeholder="Message"
                    className="col-span-1 sm:col-span-2 w-full  hover:border-[#FD6400] border border-primary border-opacity-60 rounded-md p-2 h-32 resize-none"
                  ></textarea>

                  <button
                    type="submit"
                    className="col-span-1 sm:col-span-2 bg-black text-white py-2 px-4 rounded-md"
                  >
                    Contact Us
                  </button>
                </form>
              ...
              <aside className="space-y-6">
                <div>
                  ...
                  <form action="#" className="relative">
                    <input
                      ...
                      className="w-full dark:bg-[#17202A] border-gray-300 rounded-md p-2 pr-10 hover:border-[#FD6400] border border-primary border-opacity-60"
                    />
                ...
                <div className="mb-[40px] flex flex-col">
                  ...
                  <div className="block mb-[-25px]">
                    <Link
                      href="#"
                      className="font-light leading-[1.75] border border-primary border-opacity-60 rounded-[8px] pr-[20px] pl-[20px] py-[10px] hover:border-[#FD6400] hover:border-opacity-60  flex flex-wrap items-center justify-between mb-8"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-x-[30px] md:gap-x-[0px] relative">
                    <div className="flex items-center mb-[20px]">
                      <div className="relative w-[127px]">
                        <Link href="#" className="block w-full">
                          <img
                            src="	https://htmldemo.net/bery/bery/assets/images/properties/properties-sm-1.png"
                            className="w-full"
                            alt=""
                          />
                        </Link>
                    ...
                    <div className="flex items-center text-center">
                      <div className="relative w-[127px]">
                        <Link href="#" className="block w-full">
                          <img
                            src="	https://htmldemo.net/bery/bery/assets/images/properties/properties-sm-2.png"
                            className="w-full"
                            alt=""
                          />
                        </Link>
                ...
                <div className="mb-[40px]">
                  ...
                  <ul className="flex flex-wrap my-[-7px] mx-[-5px] font-light text-[12px]">
                    <li className="my-[7px] mx-[5px]">
                      <Link
                        href="#"
                        className="leading-none hover:border-[#FD6400] border border-primary border-opacity-60  py-[8px] px-[10px] block rounded-[4px] hover:text-secondary"
                      >
                        Real Estate
                      </Link>
                    </li>
