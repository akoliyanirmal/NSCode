    ...
    <div className="relative p-4 mb-4">
      ...
      <div className="relative">
        <div className="flex flex-col justify-center items-center">
          <p className="text-2xl sm:text-4xl text-blue-900 font-bold text-center z-20 relative capitalize mt-[45px] dark:text-gray-300">
            Check out what our customers shared #homes
          </p>
        </div>
      </div>

      <div className="flex justify-center items-center">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-5 p-5 mt-10 max-w-[1100px]">
          <Image
            src={instaImg1}
            alt="instagram image"
            className="w-full h-auto rounded-lg hover:scale-110 ease-in duration-200"
          />
          <Image
            src={instaImg2}
            alt="instagram image"
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex justify-center items-center">
              <div className="flex justify-center items-center bg-[#00000080] p-6 rounded-full">
